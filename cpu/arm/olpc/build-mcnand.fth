...
" (cd multicast-nand; make BPDIR=../../../../../.. OFW_CPU=arm CPU_CFLAGS=-fno-pie nandblaster15_rx.bin nandblaster_tx.bin; cp nandblaster15_rx.bin nandblaster_tx.bin ..)" expand$ $sh
