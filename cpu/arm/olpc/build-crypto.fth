...
" stat os.public"        expand$ $sh
" stat fw.public"        expand$ $sh
" stat fs.public"        expand$ $sh
" stat lease.public"     expand$ $sh
" stat developer.public" expand$ $sh
" stat bios_verify-${CRYPTO_VERSION}.img" expand$ $sh
" stat bios_verify-${CRYPTO_VERSION}.img.md5" expand$ $sh
